...
# Program
module encoder_8 8(d,a,b,c) ; input [7:0]d; output a,b,c; or(a,d[4],d[5],d[6],d[7]); or(b,d[2],d[3],d[6],d[7]); or(c,d[1],d[3],d[5],d[7]); endmodule image
# ENCODER8TO3
...
# output
![image](https://github.com/Kboomi/ENCODER8TO3/assets/164855485/916de3d1-e3bd-4aee-adfa-28fe2b13d50b)
# Result
